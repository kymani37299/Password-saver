...
public class AccountView extends GridPane{
	...
	public AccountView(AccountController accountController,Button actonButtton) {
		this.setHgap(5);
		this.setVgap(5);
		
		this.actionButton = actonButtton;
		...
		this.btnAction = new Button("Edit");
	...
	public void setForEdit() {
		...
		this.btnAction.setOnAction(e -> {
			...
			acc.setID(accId);
			this.accountController.editAccount(this.account, acc);
			this.account = acc;
		});
	}
